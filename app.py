...
################################################################################
	...
	def init_permissions(self):
		...
		self.permissions        = [
			...
			{'name': 'systems.all.view.rubrik',            'desc': 'View Rubrik backups on any system'},
			{'name': 'systems.all.view.cost',              'desc': 'View costing information on any system'},
			...
			{'name': 'systems.all.edit.cost',              'desc': 'Modify the costing information on any system'},
		...
		self.system_permissions = [
			...
			{'name': 'view.cost',                   'desc': 'View the system\'s costing information'},
			...
			{'name': 'edit.puppet',                 'desc': 'Change the Puppet settings'},
			{'name': 'edit.cost',                   'desc': 'Change and add system costing information'},
